...
function lib_ventframe.newFrame(params, preset)
	...
	vent.emitY               = fnn(params.emitY, preset.emitY, screen.centerY*0.9)
	...
	vent.scaleX              = fnn(params.scaleX, params.scale or preset.scaleX, preset.scaleX, 0.2)
	vent.scaleY              = fnn(params.scaleY, params.scale or preset.scaleY, preset.scaleY, 0.2)
